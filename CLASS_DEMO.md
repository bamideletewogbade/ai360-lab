...
## Recommended 45-minute flow

1. **Five minutes:** Introduce Ask, Research and Build.
2. **Five minutes:** Discuss responsible AI use and checking important claims.
...
Use this when a predictable example is useful:

```text
Business: Akwaaba Fresh
Industry: Food and beverages
Offer: Fresh Ghanaian fruit juice delivered to offices in Accra
Audience: Busy professionals and small office teams in Accra
Goal: Increase enquiries and sales
Channels: WhatsApp, Instagram and Print
Direction: Warm, energetic and trustworthy. Avoid exaggerated health claims.
```
...
Copy the reference ID shown in the interface and search for it in Hostinger
Runtime logs. Do not ask a learner to paste an API key or private brand material
into a public support channel.
