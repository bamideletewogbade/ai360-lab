...
export const metadata = publicPageMetadata({
  ...
  description: 'See practical AI360 examples for revision materials, interview preparation, funding proposals, campaign artwork, policy briefs and short videos.',
