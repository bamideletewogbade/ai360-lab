...
import { AI360StudioPack } from '../../components/AI360StudioPack'
import { COLORS, customSpring, SPRINGS } from '../../theme'

export const Scene5StudioPack: React.FC = () => {
    ...
    >
      <div style={{ transform: `scale(${badgeSpring})`, marginBottom: 16 }}>
        ...
        >
          <span>STEP 04</span>
          <span>·</span>
          <span style={{ color: COLORS.clay }}>Structured Studio Deliverables (Not a Wall of Text)</span>
        </div>
      </div>

      <AI360WorkspaceFrame activeMode="studio" title="AI360 Studio · Akwaaba Fresh Launch Pack" credits={142}>
