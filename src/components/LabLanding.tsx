    ...
    <main className="landing-shell">
      ...
      <section className="landing-section outcomes" id="outcomes">
        <div className="landing-section-head">
          ...
          <span>No special words or technical experience needed. Explain what matters to you and AI 360 helps you take the next useful step. <Link href="/what-you-can-make">See real examples for your situation ↗</Link></span>
        </div>
      ...
      <section className="landing-process" id="how">
        <div className="process-copy">
          ...
          <p className="process-more"><Link href="/how-it-works">What happens at each step, what it costs, and what it will not do ↗</Link></p>
        </div>
      ...
      <footer className="landing-footer">
        ...
        <div><Link href="/what-you-can-make">What you can make</Link><Link href="/how-it-works">How it works</Link><Link href="/pricing">Pricing</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></div>
      </footer>
    </main>
  )
}
